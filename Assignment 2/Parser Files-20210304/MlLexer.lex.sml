...
{fin = [], trans = 1},
{fin = [(N 31)], trans = 0},
{fin = [(N 25),(N 31)], trans = 4},
{fin = [(N 25)], trans = 4},
{fin = [(N 25),(N 31)], trans = 6},
{fin = [(N 2)], trans = 0},
{fin = [(N 15),(N 31)], trans = 0},
{fin = [(N 7),(N 11),(N 31)], trans = 0},
{fin = [(N 18),(N 31)], trans = 10},
{fin = [(N 18)], trans = 10},
{fin = [(N 9),(N 31)], trans = 0},
{fin = [(N 27),(N 31)], trans = 0},
{fin = [(N 22),(N 31)], trans = 0},
{fin = [(N 29),(N 31)], trans = 0},
{fin = [(N 20),(N 31)], trans = 0},
{fin = [(N 13),(N 31)], trans = 0},
{fin = [(N 5),(N 31)], trans = 18},
{fin = [(N 5)], trans = 18}])
end
...
| 13 => (LPAREN)
| 15 => (EQ)
| 18 => let val yytext=yymktext() in NUM  (List.foldr (fn(a,r)=>ord(a)-ord(#"0")+10*r) 0 (explode yytext)) end
| 2 => (refinc linenum; lex())
| 20 => (RPAREN)
| 22 => (PLUS)
| 25 => let val yytext=yymktext() in if yytext="print" then PRINT else ID yytext end
| 27 => (SUB)
| 29 => (TIMES)
| 31 => let val yytext=yymktext() in error ("calc: ignoring bad character "^yytext); lex() end
| 5 => (lex())
| 7 => (EOF)
| 9 => let val yytext=yymktext() in DIV yytext end
